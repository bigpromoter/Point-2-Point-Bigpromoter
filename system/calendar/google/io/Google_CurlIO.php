...
class Google_CurlIO implements Google_IO {
  ...
  public function makeRequest(Google_HttpRequest $request) {
    ...
    if ($curlErrorNum != CURLE_OK) {
	  ...
	  echo 'Either 1) Connection error to Google server. You may neglect this message if it is happening sporadically, or 2) SSL certificate problem, verify that the CA cert is OK.';	 	 	 	 	   		 	 			
